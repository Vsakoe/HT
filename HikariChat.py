...
# Author: hikariatama
# Commands:
# .purge       | .del      | .version    | .deleted  | .fclean  
# .newfed      | .rmfed    | .fpromote   | .fdemote  | .fadd    
# .frm         | .fban     | .punishsuff | .sethclog | .funban  
# .fmute       | .funmute  | .kick       | .ban      | .mute    
# .unmute      | .unban    | .protects   | .feds     | .fed     
# .pchat       | .warn     | .warns      | .delwarn  | .clrwarns
# .clrallwarns | .welcome  | .fdef       | .fsave    | .fstop   
